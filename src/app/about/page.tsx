          ...
          <div className="grid gap-10 lg:grid-cols-12">
            <div className="lg:col-span-7">
              ...
              <p className="mt-4 max-w-2xl text-sm leading-relaxed text-muted-foreground md:text-base">
                ...
                We thought that was nuts — so we built Prospio. One graph, one bill, one workflow.
              </p>
      ...
      <Section>
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="space-y-5 text-sm leading-relaxed lg:col-span-8 lg:border-l lg:border-border lg:pl-10">
            ...
            <p className="text-muted-foreground">
              Prospio is a bet in the other direction. Fewer signals, verified deeper. Sources
        ...
        <div className="mt-10 grid gap-px overflow-hidden rounded-3xl border border-border bg-border md:grid-cols-2 lg:grid-cols-3">
          {team.map((member) => (
            <div key={member.name} className="flex items-center gap-4 bg-card p-5">
              ...
              <span className="shrink-0 text-xs uppercase tracking-[0.2em] text-muted-foreground hidden sm:block">
                {member.location}
              </span>
            </div>
          ))}
